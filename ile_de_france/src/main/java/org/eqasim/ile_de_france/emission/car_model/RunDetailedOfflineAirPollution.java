...
public class RunDetailedOfflineAirPollution {
...
//	static final String configFile = outputPath + "./output_config.xml";
	...
	static final String hbefaFileCold =  inputHbefaPath+ "./EFA_ColdStart_Subsegm_2022_Detailed_Marjolaine_vf.csv";
	static final String hbefaFileWarm =  inputHbefaPath+ "./EFA_HOT_Subsegm_2022_Detailed_Marjolaine_vf.csv";

	static final String emissionEventOutputFileName = inputFilePath + "./emissions_detailed.xml.gz";
...
//		config.transit().setVehiclesFile(null);
		...
		config.vehicles().setVehiclesFile(inputFilePath + "./output_vehicles_detailed.xml.gz"); // need change the "defaultVehicleType" to "car" in output_vehicles.file" or see new method for output_vehicle.xml
